    ...
    <View style={[styles.container, { paddingHorizontal: containerPadding }]}> 
      ...
      {isPortrait ? (
        <View style={[styles.card, { paddingHorizontal: Math.round(containerPadding / 2), maxWidth: maxContentWidth, paddingVertical: isPortrait ? 24 : 12, alignItems: 'center', justifyContent: 'space-between', minHeight: Math.round(isPortrait ? winHeight * 0.68 : winHeight * 0.82), paddingBottom: Math.round((isPortrait ? 16 * fontScale : 12 * fontScale) + (insets.bottom || 0)), flex: 1 }]}>
          {/* Centered top content (logo + brand + greeting) */}
          <View style={{ alignSelf: 'stretch', flexGrow: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: Math.round(6 * fontScale) }}>
            ...
            {/* Keep user greeting under brand to preserve content */}
            <View style={{ marginTop: Math.round(12 * fontScale), alignItems: 'center' }}>
              <Text style={[styles.greetingLarge, { fontSize: Math.round(32 * fontScale) }]}>Hello {username}</Text>
              <Text style={[styles.greetingSubtitle, { fontSize: Math.round(12 * fontScale), marginTop: Math.round(6 * fontScale) }]}>Welcome back — pick an option</Text>
            </View>
          </View> 
        ...
        >
          {/* Left: full-viewport panel containing centered logo + brand + greeting */}
          <View style={{ width: winWidth, justifyContent: 'center', alignItems: 'center', paddingVertical: Math.round(12 * fontScale) }}>
            <View style={{ width: maxContentWidth, alignItems: 'center' }}>
              ...
              <View style={{ marginTop: Math.round(12 * fontScale), height: Math.round(winHeight * 0.12), justifyContent: 'center', alignItems: 'center' }}>
                <Text style={[styles.greetingLarge, { fontSize: Math.round(28 * fontScale) }]}>Hello {username}</Text>
                <Text style={[styles.greetingSubtitle, { fontSize: Math.round(12 * fontScale), marginTop: Math.round(6 * fontScale) }]}>Welcome back — pick an option</Text>
              </View>
            </View>
          </View> 
